...
En este proyecto te presentamos un contenido de gran valor para todas aquellas personas que quieren aprender a programar en Javascript, en donde vamos a mostrarte hasta una cantidad de 8 maneras distintas de encontrar la palabra más larga existente en una frase o cadena de texto (string). 
